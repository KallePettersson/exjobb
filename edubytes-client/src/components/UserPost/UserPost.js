...
const UserPost = () => {
  ...
  // const address = "https://kalle-test-env.azurewebsites.net"
  // const address = process.env.BACKEND_BASE_API == undefined ? "https://kalle-test-env.azurewebsites.net": process.env.BACKEND_BASE_API ;
